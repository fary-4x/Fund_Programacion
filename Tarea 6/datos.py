...
class Vacunacion(Model):
    personasid= ForeignKeyField(Personas, backref='Vacunados')
    vacunaid= ForeignKeyField(Vacunas, backref='Vacuna')
    provinciaid= ForeignKeyField(Provincias, backref='Lugar')
    fechav= CharField()
...
db.connect()
db.create_tables([Personas,Vacunacion,Vacunas,Provincias])
