...
def  Agregar():
    ...
    r.monto = input('Ingrese el valor RD$ : ' )
    r.ubicacion = input('Ingrese el lugar donde fue asaltado: ' )
    r.latitud = input('Ingrese la latitud de la ubicacion: ' )
    r.longitud = input('Ingrese la longitud de la  ubicacion: ' )
    r.save()
    
    input('Los datos han sido guardados con exito, purlse enter para continuar...')
        ...
        <body>
            <div>
                ...
                <center>
                     ...
                     <h2>Fecha del asalto:<b>{r.fecha}</b></h2>
